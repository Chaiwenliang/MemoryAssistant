...
| 首页对话界面 |
|:---:|
| ![首页智能问答](screenshots/01-home.png) |
...
| 全部记录列表 | 记录详情页 |
|:---:|:---:|
| ![全部记录](screenshots/04-records.png) | ![记录详情](screenshots/05-record-detail.png) |
| 分类浏览所有记忆，支持搜索和排序 | 查看完整信息，一键编辑或删除 |

| 新增记录表单 |
|:---:|
| ![新增记录](screenshots/06-record-form.png) |
...
| 快速语音录入 |
|:---:|
| ![快速记录](screenshots/07-quick-capture.png) |
| 长按说话，自动语音识别并智能分类保存 |
...
| 设置页面 |
|:---:|
| ![设置中心](screenshots/02-settings.png) |
| 主题切换、数据管理、AI 配置、关于等 |
